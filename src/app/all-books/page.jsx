  ...
  return (
    <div className="max-w-7xl mx-auto px-5 py-10">
      ...
      <h1 className="text-4xl md:text-6xl font-bold text-center mb-4">
        Discover Your Next <span className="text-yellow-500">Great Read</span>
      </h1>

      <p className="text-center text-gray-500 max-w-2xl mx-auto mb-10">
        Explore our vast collection of books across various categories. Find
        exactly what you're looking for or stumble upon a hidden gem.
      </p>
